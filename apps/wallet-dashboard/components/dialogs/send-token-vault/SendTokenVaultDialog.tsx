...
import { CoinBalance, DryRunTransactionBlockResponse, getNetwork } from '@iota/iota-sdk/client';
import { fromBase64, IOTA_TYPE_ARG } from '@iota/iota-sdk/utils';
...
function SendTokenVaultDialogBody({
    ...
    async function handleProposition() {
        ...
        console.log(transactionData.transaction.getData());
    ...
    return (
        <>
            ...
            {step === FormStep.TransactionDetails && dryRunResponse && (
                <TransactionDetailsLayout
                    transaction={getExtendedTransaction(
                        {
                            ...dryRunResponse,
                            digest: '',
                        },
