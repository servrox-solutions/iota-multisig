...
import { getVaultsOfCurrentUser } from 'iota-vault-sdk';
import { MultiSigPublicKey } from '../../../sdk/typescript/dist/esm/multisig/publickey';

const vaultsByUser = async (): Promise<Vault[] | null> => {
    const dbData = (await getVaultsOfCurrentUser()) as
        | Database['public']['Views']['vaults_of_current_user']['Row'][]
        | null;
